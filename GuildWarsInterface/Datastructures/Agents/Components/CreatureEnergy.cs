...
namespace GuildWarsInterface.Datastructures.Agents.Components
{
    public sealed class CreatureEnergy : AgentBasicResource
    {
        ...
        protected override void OnRegenerationChanged()
        {
            ...
            {
                _creature.SendAgentPropertyFloat(AgentProperty.EnergyRegeneration, 0.03F);
                //_creature.SendAgentPropertyFloat(AgentProperty.EnergyRegeneration, Regeneration / 100);
            }
        }
        ...
        {
            source.SendAgentTargetPropertyFloat(AgentProperty.EnergyRegeneration, _creature, change);
        }
    }
}